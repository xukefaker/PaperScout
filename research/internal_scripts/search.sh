...
CLI_BIN="${CLI_BIN:-$VENV_DIR/bin/paperscout}"
...
export PAPERSCOUT_LOG_LEVEL="$LOG_LEVEL"

set_env_if_nonempty "PAPERSCOUT_DATA_DIR" "$DATA_DIR_OVERRIDE"
set_env_if_nonempty "OPENAI_BASE_URL" "$OPENAI_BASE_URL_OVERRIDE"
set_env_if_nonempty "OPENAI_MODEL" "$OPENAI_MODEL_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_REQUEST_TIMEOUT" "$REQUEST_TIMEOUT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_PAPER_DENSE_MODEL" "$PAPER_DENSE_MODEL_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_CHUNK_DENSE_MODEL" "$CHUNK_DENSE_MODEL_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_DENSE_DEVICE" "$DENSE_DEVICE_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_DENSE_BATCH_SIZE" "$DENSE_BATCH_SIZE_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_RERANKER_ENABLED" "$RERANKER_ENABLED_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_RERANKER_MODEL" "$RERANKER_MODEL_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_RERANKER_DEVICE" "$RERANKER_DEVICE_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_RERANKER_BATCH_SIZE" "$RERANKER_BATCH_SIZE_OVERRIDE"

set_env_if_nonempty "PAPERSCOUT_CANDIDATE_POOL_SIZE" "$CANDIDATE_POOL_SIZE_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_CANDIDATE_SOURCE_LIMIT" "$CANDIDATE_SOURCE_LIMIT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_PAPER_SPARSE_RRF_WEIGHT" "$PAPER_SPARSE_RRF_WEIGHT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_PAPER_DENSE_RRF_WEIGHT" "$PAPER_DENSE_RRF_WEIGHT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_CHUNK_AGGREGATED_RRF_WEIGHT" "$CHUNK_AGGREGATED_RRF_WEIGHT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_LITERAL_ENTITY_RRF_WEIGHT" "$LITERAL_ENTITY_RRF_WEIGHT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_EXACT_PHRASE_RRF_WEIGHT" "$EXACT_PHRASE_RRF_WEIGHT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_ASPECT_COVERAGE_BONUS" "$ASPECT_COVERAGE_BONUS_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_SOURCE_DIVERSITY_BONUS" "$SOURCE_DIVERSITY_BONUS_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_LITERAL_ENTITY_BONUS" "$LITERAL_ENTITY_BONUS_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_EXACT_PHRASE_BONUS" "$EXACT_PHRASE_BONUS_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_EVIDENCE_SPARSE_WEIGHT" "$EVIDENCE_SPARSE_WEIGHT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_EVIDENCE_DENSE_WEIGHT" "$EVIDENCE_DENSE_WEIGHT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_EVIDENCE_RERANKER_WEIGHT" "$EVIDENCE_RERANKER_WEIGHT_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_EVIDENCE_RERANKER_CANDIDATE_CHUNKS" "$EVIDENCE_RERANKER_CANDIDATE_CHUNKS_OVERRIDE"
set_env_if_nonempty "PAPERSCOUT_EVIDENCE_CHUNK_TEXT_LIMIT" "$EVIDENCE_CHUNK_TEXT_LIMIT_OVERRIDE"
